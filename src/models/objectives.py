...
def evaluate_footprint(t_0, r, d, o):
    ...
    print(f"at {t} we need {migration_steps_seconds} steps to migrate and {remaining_seconds} seconds\njob size: {r.input_size_bytes} bytes, migration time: {migration_time} seconds, migration energy: {migration_energy_kWh} kWh")
